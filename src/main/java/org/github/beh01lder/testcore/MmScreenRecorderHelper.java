...
public class MmScreenRecorderHelper extends ScreenRecorder {
	public static ScreenRecorder screenRecorder;
	public String name;

	public MmScreenRecorderHelper(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat,
	...
	public static void startRecording(String methodName) throws Exception {
		File file = new File("./video-recordings/");
		Rectangle captureSize = new Rectangle(0, 0, 1360, 768);
		GraphicsConfiguration gc = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().getDefaultConfiguration();

		screenRecorder = new MmScreenRecorderHelper(gc, captureSize,
